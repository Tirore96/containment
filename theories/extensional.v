...
Definition decP (r0 r1 : @regex A) := bisim_wrap [::r0] [::r1].
Lemma P_decidable : forall r0 r1, decP r0 r1 <-> forall s, P s r0 r1.
Proof.
intros. split. move/bisim_sound. move/Extensional_equiv.
move=> H s. rewrite !big_cons !big_nil in H.
intros. apply P_empt. done.
intros. apply/bisim_complete. apply/Bisim_co_ind.
intros. rewrite !big_cons !big_nil. apply P_empt. done.
Qed.
End Extensional.
