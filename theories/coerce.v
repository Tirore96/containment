...
| c_fix r0 r1 : co_eq r0 r1 ->  r0 =R= r1
...
Proof.
pcofix CIH.
move=> c. pfold. apply/c_fix. right. apply/CIH.
...
Lemma star_o : forall R c c', Star (o (c) _+_ c') =(R) = c'.
Proof.
move=> R c c'. 
...
- move=> r HQ /=. 
  under eq_big_plus. move=> a Hin. rewrite -c_seq_assoc. over.
  rewrite factor_seq_r /o /=.
  apply/c_trans. apply/c_star_ctx. apply: HQ. 
...
Section Containment.
  Variable co_sub : regex -> regex -> Prop.
Reserved Notation "c0 <R= c1" (at level 63).


(*Maybe c_star_ctx and c_star_plus are not necessary*)

Inductive c_ineq : regex -> regex -> Prop :=
| ci_plus_assoc c0 c1 c2 : (c0 _+_ c1) _+_ c2 <R= c0 _+_ (c1 _+_ c2)
| ci_plus_assoc_inv c0 c1 c2 : c0 _+_ (c1 _+_ c2)  <R= (c0 _+_ c1) _+_ c2

| ci_plus_comm c0 c1: c0 _+_ c1 <R= c1 _+_ c0

| ci_plus_neut c: c _+_ Empt <R= c
| ci_plus_neut_inv c: c <R= c _+_ Empt

| ci_plus_idemp c : c _+_ c <R= c 
| ineq_tagL c d : c <R= c _+_ d

| ci_seq_assoc c0 c1 c2 : (c0 _;_ c1) _;_ c2 <R= c0 _;_ (c1 _;_ c2)
| ci_seq_assoc_inv c0 c1 c2 : c0 _;_ (c1 _;_ c2) <R=  (c0 _;_ c1) _;_ c2

| ci_seq_neut_l c : (Eps _;_ c) <R= c 
| ci_seq_neut_l_inv c : c <R= (Eps _;_ c)

| ci_seq_neut_r c : c _;_ Eps <R= c 
| ci_seq_neut_r_inv c : c <R= c _;_ Eps

| ci_seq_failure_l c : Empt _;_ c <R= Empt
| ci_seq_failure_l_inv c :  Empt  <R= Empt _;_ c
  
| ci_seq_failure_r c :  c _;_ Empt <R= Empt 
| ci_seq_failure_r_inv c : Empt <R=  c _;_ Empt 

| ci_distr_l c0 c1 c2 : c0 _;_ (c1 _+_ c2) <R= (c0 _;_ c1) _+_ (c0 _;_ c2)
| ci_distr_l_inv c0 c1 c2 : (c0 _;_ c1) _+_ (c0 _;_ c2)  <R=  c0 _;_ (c1 _+_ c2)

| ci_distr_r c0 c1 c2 : (c0 _+_ c1) _;_ c2 <R= (c0 _;_ c2) _+_ (c1 _;_ c2)
| ci_distr_r_inv c0 c1 c2 :  (c0 _;_ c2) _+_ (c1 _;_ c2)  <R= (c0 _+_ c1) _;_ c2


| ci_unfold c :  Eps _+_ (c _;_ Star c) <R= Star c
| ci_unfold_inv c :  Star c  <R=Eps _+_ (c _;_ Star c)

| ci_star_plus c :  Star (Eps _+_ c) <R= Star c
...
| ci_trans c0 c1 c2 (H1 : c0 <R=c1) (H2 : c1 <R=c2) : c0 <R=c2
| ci_plus_ctx c0 c0' c1 c1' (H1 : c0 <R=c0') (H2 : c1 <R=c1') : c0 _+_ c1 <R=c0' _+_ c1'
| ci_seq_ctx c0 c0' c1 c1' (H1 : c0 <R=c0') (H2 : c1 <R=c1') : c0 _;_ c1 <R=c0' _;_ c1'
| ci_star_ctx c0 c1 (H : c0 =R=c1) : Star c0 =R= Star c1  (*new context rule*) 
| ci_fix (l0 l1 : seq (A * regex)) : Forall2 (fun x y => x.1 = y.1) l0 l1 -> Forall2 (fun r0 r1 => co_eq r0.2 r1.2) l0 l1 ->
