...
Lemma derive_unfold_coerce : forall c, dsl nil c (o c _+_ \big[Plus/Empt]_(a : Af) (Event a _;_ a \ c))  *
                                   dsl nil (o c _+_ \big[Plus/Empt]_(a : Af) (Event a _;_ a \ c)) c.
Proof.
elim;try solve [auto].
 ...
 * 
   ...
   lcp1. lcid. lcid. 
 * 
yes   lct2. lcp1. apply:Hd0'. apply:Hd1'. 
...
(*  rewrite /o Heqn Heqn2 in Hd0 Hd1.*)
  ...
  lct2. apply :distRinv. 
  lct2. lcp1. lct2. rewrite /o Heqn.
  apply:projinv. (*Because nu r0 = true, we will recurse in both cases of r0 Eps _+_ ..., apply Hd1 *) apply Hd1'. lcid.
  lct2. apply shuffleinv. lcp1. lcid.
  lct1. apply:retag. lcid.
  ...
  lct2. apply :distRinv. 
  lct2. lcp1. rewrite /o Heqn.
  apply:abortLinv. lcid. lcid.
    
- move=> r0 [] Hd Hd'. con. 


(*  move=> r0 Hd.*) rewrite /o /=.  
 * destruct (nu r0) eqn:Heqn. rewrite /o Heqn in Hd Hd'.
  lct1. apply:cstar. apply Hd.
  lct1. apply:drop.
  lct1. apply:wrapinv.
  apply:cplus. lcid.
  lct2. lct2. apply:eq_big_plus_c. intro. intros. apply:assoc.  apply:factor_seq_r_r.  
  apply:cseq. lcid. lct1. apply:dropinv. lct1. apply:cstar. apply:Hd'. lcid.
  lct1. apply:wrapinv. apply:cplus. lcid.
  lct1. apply:cseq. apply:Hd. lcid. rewrite /o Heqn /=.
  lct1. apply:cseq. apply:untagL. lcid.
  lct2. apply:eq_big_plus_c. intro. intros. apply:assoc.  apply:factor_seq_r_r.  

 * destruct (nu r0) eqn:Heqn. rewrite /o Heqn in Hd Hd'.
  lct2. apply:cstar. apply Hd'.
  lct2. apply:dropinv.
  lct2. apply:wrap. rewrite /o /=.
  apply:cplus. lcid.
  lct1. lct1. apply:eq_big_plus_c. intro. intros. simpl.  apply:associnv.  apply:factor_seq_r_l.  
  apply:cseq. lcid. lct2. apply:drop. lct1. apply:cstar. apply:Hd. lcid.
  lct2. apply:wrap. apply:cplus. lcid.
  lct2. apply:cseq. apply:Hd'. lcid. rewrite /o Heqn /=.
  lct2. apply:cseq. apply:untagLinv. lcid.
  lct1. apply:eq_big_plus_c. intro. intros. apply:associnv.  apply:factor_seq_r_l.  
Defined.
...
Extraction "../bench/lib/testsuiteslow" test.
