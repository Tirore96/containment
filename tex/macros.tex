...
\newcommand{\matchv}[2]{\vdash #1 \in #2}

\newcommand{\mynu}[1]{\mathsf{nu}(#1)}
\newcommand{\mynueq}[2]{\mynu{#1}=#2}
...
\newcommand{\myfix}[2]{\mathsf{fix}~\mathsf{#1}.#2}
\newcommand{\oft}[2]{#1 : #2}
\newcommand{\oftv}[2]{\vdash #1 : #2}
...
\newcommand{\flattenn}{\mathsf{flatten}}
\newcommand{\parse}[1]{\mathsf{parse}(#1)}
\newcommand{\parset}[2]{\mathsf{parse}(#1,#2)}
...
\newcommand{\monarrow}{\xrightarrow{{\text{mon}}}}
\newcommand{\simind}{\sim_{ind}}
\newcommand{\derivearrow}[1]{\xrightarrow{\derive{#1}{\cdot}}}
\newcommand{\re}{re}
\newcommand{\decn}{4}
\newcommand{\dentry}[2]{\begin{tabular}{c} #1 \\  #2 \end{tabular}}

\newcommand{\ddentryone}[4]{\begin{tabular}{n{4}{\decn}} #1 \\  #3 \end{tabular}}

\newcommand{\ddentrytwo}[4]{\begin{tabular}{n{4}{\decn}} #2 \\  #3 \end{tabular}}

\newcommand{\ddentrysone}[4]{\begin{tabular}{l} #1 \\ #3 \end{tabular}}

\newcommand{\ddentrystwo}[4]{\begin{tabular}{l} #2 \\ #4 \end{tabular}}

\newcommand{\ddentry}[4]{\begin{tabular}{n{4}{\decn}} #1 \\ #3\\ #2 \\ #4 \end{tabular}}
\newcommand{\ddentrys}[4]{\begin{tabular}{l} #1 \\ #3\\ #2 \\ #4 \end{tabular}}

\newcommand{\tabline}[6]{#1 & #2 & #3 & #4 & #5 & #6}
\newcommand{\dlentry}[2]{\begin{tabular}{n{3}{\decn}} #1 \\ #2 \end{tabular}}
\newcommand{\dlentrys}[2]{\begin{tabular}{l} #1 \\ #2 \end{tabular}}
\newcommand{\rentryone}[2]{$#1 \leq #2$}
\newcommand{\rentrytwo}[2]{$#2 \leq #1$}



\newcommand{\dawit}[1]{\textcolor{red}{\footnotesize Dawit: #1}}

\newcommand{\coq}[1]{\textsf{#1}}

\newcommand{\ptree}[2]{\vdash #1: #2}
\newcommand{\bder}[3]{#1_{#2_{#3}}}
\newcommand{\bdereq}[4]{\bder{#1}{#2}{#3} = #4}
\newcommand{\HN}{Henglein \& Nielsen}
